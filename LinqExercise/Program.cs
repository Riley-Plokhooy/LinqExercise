...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Numbers desc:");
            ...
            numbers.Select((number, index) => index == 4 ? 18 : number).OrderByDescending(x => x).ToList().ForEach(x => Console.WriteLine(x));
            ...
            Console.WriteLine($"Average years of experience: {specialFilteredEmployees.Average(x => x.YearsOfExperience)}");

            //TODO: Add an employee to the end of the list without using employees.Add()


            employees = employees.Append(new Employee ( "Jane", "Doe", 30, 5 )).ToList();
